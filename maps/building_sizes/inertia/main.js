...
// data/prepare_data.py to overlays/basic_lengths_inertia.geojson alongside each
...
function renderLegend() {
  ...
  heading.textContent = "Building size arrows (inertia axes)";
...
async function loadDataset(datasetId) {
  ...
  try {
    state.arrowsData = await fetch(`${dir}/overlays/basic_lengths_inertia.geojson`).then((r) => r.json());
  } catch {
